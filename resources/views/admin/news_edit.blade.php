        ...
        <div class="col-xs-12">
            ...
            <div class="card">
                <div class="card-header" data-background-color="purple">
                    <h4 class="title">ویرایش خبر</h4>
                    <p class="category">برای ویرایش خبر، فرم زیر را ویرایش نمایید.</p>
                </div>
                            ...
                            <div class="col-md-10 col-md-offset-1 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-10 pull-right">
                                        <input maxlength="25" name="title" class="form-control" value="{{$data->title}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="colxs-12 col-md-2 pull-right">
                                    ...
                                    <div class="col-xs-12 col-md-10 pull-right">
                                        <textarea name="abstract" class="form-control">{{$data->abstract}}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="colxs-12 col-md-2 pull-right">
                                    ...
                                    <div class="col-xs-12 col-md-10 pull-right">
                                        <textarea name="body" id="body" class="form-control">{{strip_tags($data->body)}}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="colxs-12 col-md-2 pull-right">
                                    ...
                                    <div class="col-xs-12 col-md-6 pull-right">
                                        ...
                                        <div id="photo" class="portfolio-item" style='background-image: url("@if($data->img){{asset($data->img)}} @else {{asset('img/default-news.jpg')}} @endif");'>
                                            <div class="details">
                                                <h4>تعویض تصویر</h4>
                                            </div>
                                        </div>
