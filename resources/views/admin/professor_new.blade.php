        ...
        <div class="col-xs-12">
            ...
            <div class="card">
                <div class="card-header" data-background-color="purple">
                    <h4 class="title">ثبت نام استاد</h4>
                    <p class="category">برای ثبت نام استاد جدید، فرم زیر را پر نمایید.</p>
                </div>
                        ...
                        <div class="col-md-10 col-md-offset-1 col-xs-12">
                            ...
                            <div class="row margin-bottom-15">
                                ...
                                <div class="col-xs-12 col-md-10 pull-right">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="optionsRadios" checked value="female"> زن
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-10 pull-right">
                                    <input id="birth_day" name="birth_day" class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="colxs-12 col-md-2 pull-right">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-10 pull-right">
                                    <input name="phone" class="form-control" placeholder="برای نمونه : 9249-3252-056">
                                </div>
                            </div>
                            <div class="row">
                                <div class="colxs-12 col-md-2 pull-right">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-10 pull-right">
                                    <textarea maxlength="255" name="address" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="colxs-12 col-md-2 pull-right">
                                ...
                                <div class="col-xs-12 col-md-5 pull-right">
                                    ...
                                    <div id="photo" class="portfolio-item" style='background-image: url("{{asset('img/admin/smsts-refresher-big.png')}}");'>
                                        <div class="details">
                                            <h4>تعویض تصویر</h4>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <input name="save_professor" type="button" class="btn btn-primary pull-left submit_button" value="ثبت">
                            </div>
                        </div>
                    </form>
                </div>
