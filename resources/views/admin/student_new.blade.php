        ...
        <div class="col-xs-12">
            ...
            <div class="card">
                <div class="card-header" data-background-color="purple">
                    <h4 class="title">ثبت نام دانشجو</h4>
                    <p class="category">برای ثبت نام دانشجوی جدید، فرم زیر را پر نمایید.</p>
                </div>
                    ...
                    <form name="news" class="" enctype='#'>
                        <div class="col-md-10 col-md-offset-1 col-xs-12">
                            ...
                            <div class="row margin-bottom-5">
                                ...
                                <div class="col-xs-12 col-md-10 pull-right">
                                    <input id="birth_day" name="birth_day" class="form-control" placeholder="روز/ماه/سال">
                                </div>
                            </div>
                            <div class="row margin-bottom-5">
                                <div class="colxs-12 col-md-2 pull-right">
                            ...
                            <div class="row margin-bottom-5">
                                ...
                                <div class="col-xs-12 col-md-10 pull-right">
                                    ...
                                    @endif
                                    {{--<input name="entry_semester" class="form-control" placeholder="برای نمونه : 1395-مهر">--}}
                                </div>
                            </div>
                            <div class="row margin-bottom-5">
                                <div class="colxs-12 col-md-2 pull-right">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-5 pull-right">
                                    ...
                                    <div id="photo" class="portfolio-item"
                                         style='background-image: url("{{asset('img/default-student.png')}}");'>
                                        <div class="details">
                                            <h4>تعویض تصویر</h4>
                                        </div>
                                    </div>
