        ...
        <div class="col-xs-12">
            ...
            <div class="card">
                <div class="card-header" data-background-color="purple">
                    <h4 class="title">ویرایش کلاس</h4>
                    <p class="category">برای ویرایش کلاس، فرم زیر را پر نمایید.</p>
                </div>
                        ...
                        <div class="col-md-10 col-md-offset-1 col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-10 pull-right">
                                    <input name="name_class" class="form-control" value="{{$class->name}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="colxs-12 col-md-2 pull-right">
                                ...
                                <div class="col-xs-12 col-md-10 pull-right">
                                    <input type="number" name="number_class" class="form-control" value="{{$class->number}}">
                                </div>
                            </div>
                            <div class="row">
                                <input name="save_class" type="button" class="btn btn-primary pull-left submit_button" value="ثبت">
                            </div>
                        </div>
                    </form>
                </div>
